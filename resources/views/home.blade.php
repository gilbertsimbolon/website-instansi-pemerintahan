            ...
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div class="flex lg:flex-1">
                    <a href="#" class="-m-1.5 p-1.5">
                        <span class="sr-only">Pengadilan Negeri Tondano</span>
                        <img class="w-auto h-16"
                            src="https://pn-tondano.go.id/wp-content/uploads/pictures/logo/Logo%20Pengadilan%20Negeri%20Tondano%20(Warna).png" alt="Logo Pengadilan Negeri Tondano Berwarna">
                    </a>
                    <h3 class="mt-1 font-semibold uppercase">mahkamah agung republik indonesia <br> pengadilan negeri tondano</h3>
                </div>
                    ...
                    <div class="flow-root mt-6">
                        <div class="-my-6 divide-y divide-gray-500/10">
                            <div class="py-6 space-y-2">
                                <a href="#"
                                    class="block px-3 py-2 -mx-3 font-semibold text-gray-900 rounded-lg text-base/7 hover:bg-gray-50">Product</a>
                                <a href="#"
        ...
        <div class="relative px-6 isolate pt-14 lg:px-8">
            ...
            <div class="max-w-2xl py-32 mx-auto sm:py-48 lg:py-56">
                ...
                <div class="text-center">
                    <h1 class="text-5xl font-semibold tracking-tight text-gray-900 text-balance sm:text-7xl">Data to enrich
                        your online business</h1>
                    <p class="mt-8 text-lg font-medium text-gray-500 text-pretty sm:text-xl/8">Anim aute id magna aliqua ad
